function [ProbP300_2cls, ProbP300_4cls] = SVMcalcmain_P300_R(directory_Training, directory_Trial)

% === % === T r a i n i n g % === % ===
% --- Feature generation by signal file
[Signal_Target1, Sampling_Hz] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_Target1_R*.csv')]));
[Signal_Target2] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_Target2_R*.csv')]));
[Signal_Target3] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_Target3_R*.csv')]));
[Signal_Target4] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_Target4_R*.csv')]));
[Signal_NonTarget1] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_NonTarget1_R*.csv')]));
[Signal_NonTarget2] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_NonTarget2_R*.csv')]));
[Signal_NonTarget3] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_NonTarget3_R*.csv')]));
[Signal_NonTarget4] = fileProcessor_dir(directory_Training, dir(['./', directory_Training, horzcat('/[5] P300-SBE_NonTarget4_R*.csv')]));
...
[gamma4cls1, cost4cls1] = SVMlibsvm_cvtestP300(Train1_Data, Train1_Label, directory_Training, 'Target1_R');
[gamma4cls2, cost4cls2] = SVMlibsvm_cvtestP300(Train2_Data, Train2_Label, directory_Training, 'Target2_R');
[gamma4cls3, cost4cls3] = SVMlibsvm_cvtestP300(Train3_Data, Train3_Label, directory_Training, 'Target3_R');
[gamma4cls4, cost4cls4] = SVMlibsvm_cvtestP300(Train4_Data, Train4_Label, directory_Training, 'Target4_R');
[gamma2clsA, cost2clsA] = SVMlibsvm_cvtestP300(TrainA_Data, TrainA_Label, directory_Training, 'TargetA_R');
[gamma2clsB, cost2clsB] = SVMlibsvm_cvtestP300(TrainB_Data, TrainB_Label, directory_Training, 'TargetB_R');

Parameter = [gamma4cls1, cost4cls1; gamma4cls2, cost4cls2; gamma4cls3, cost4cls3;...
    gamma4cls4, cost4cls4; gamma2clsA, cost2clsA; gamma2clsB, cost2clsB;];

save(strcat(directory_Training, '/gamma_cost_Parameter_R.mat'), 'Parameter');
